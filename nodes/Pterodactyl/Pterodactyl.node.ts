			...
			},
			{
				...
				options: [
					...
					},
					{
						name: 'Power Action',
						value: 'power',
						description: 'Send power action to server (Client API only)',
						action: 'Power action on server',
					},
					{
						name: 'Send Command',
						value: 'sendCommand',
						description: 'Execute command on server console (Client API only)',
				...
				options: [
					{
						name: 'List',
						value: 'list',
						description: 'List files in directory (Client API only)',
						action: 'List files',
					},
					{
						name: 'Read',
						value: 'read',
						description: 'Read file contents (Client API only)',
						action: 'Read file',
					},
					{
						name: 'Write',
						value: 'write',
						description: 'Write file contents (Client API only)',
						action: 'Write file',
					},
					{
						name: 'Delete',
						value: 'delete',
						description: 'Delete files (Client API only)',
						action: 'Delete files',
					},
					{
						name: 'Compress',
						value: 'compress',
						description: 'Compress files into archive (Client API only)',
						action: 'Compress files',
					},
					{
						name: 'Decompress',
						value: 'decompress',
						description: 'Extract archive contents (Client API only)',
						action: 'Decompress file',
					},
					{
						name: 'Create Folder',
						value: 'createFolder',
						description: 'Create a new directory (Client API only)',
						action: 'Create folder',
					},
					{
						name: 'Get Upload URL',
						value: 'getUploadUrl',
						description: 'Get signed URL for file upload (Client API only)',
				...
				options: [
					{
						name: 'List',
						value: 'list',
						description: 'List all databases (Client API only)',
						action: 'List databases',
					},
					{
						name: 'Create',
						value: 'create',
						description: 'Create a new database (Client API only)',
						action: 'Create database',
					},
					{
						name: 'Rotate Password',
						value: 'rotatePassword',
						description: 'Rotate database password (Client API only)',
						action: 'Rotate database password',
					},
					{
						name: 'Delete',
						value: 'delete',
						description: 'Delete a database (Client API only)',
				...
				options: [
					{
						name: 'List',
						value: 'list',
						description: 'List all backups (Client API only)',
						action: 'List backups',
					},
					{
						name: 'Create',
						value: 'create',
						description: 'Create a new backup (Client API only)',
						action: 'Create backup',
					},
					{
						name: 'Get',
						value: 'get',
						description: 'Get backup details (Client API only)',
						action: 'Get backup',
					},
					{
						name: 'Download',
						value: 'download',
						description: 'Get backup download URL (Client API only)',
						action: 'Download backup',
					},
					{
						name: 'Restore',
						value: 'restore',
						description: 'Restore backup to server (Client API only)',
						action: 'Restore backup',
					},
					{
						name: 'Delete',
						value: 'delete',
						description: 'Delete a backup (Client API only)',
